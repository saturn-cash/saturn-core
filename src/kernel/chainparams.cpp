// Saturn Core
// Copyright (c) 2026-present Tremoto
// Based on Bitcoin Core by Satoshi Nakamoto and contributors
...
{
    const char* pszTimestamp = "Saturn Cash genesis 2026 - A new orbit begins";
...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.saturn.boats"); // Saturn primary seed node
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.saturn.jonasschnelli.ch.");
        vSeeds.emplace_back("seed.tbtc.petertodd.net.");
        vSeeds.emplace_back("seed.testnet.saturn.sprovoost.nl.");
...
public:
    CTestNet4Params() {
        ...
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("seed.testnet4.saturn.sprovoost.nl."); // Sjors Provoost
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            vSeeds.emplace_back("seed.signet.saturn.sprovoost.nl.");
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        m_assumeutxo_data = {
            ...
            {
                // For use by test/functional/feature_assumeutxo.py and test/functional/tool_saturn_chainstate.py
                .height = 299,
